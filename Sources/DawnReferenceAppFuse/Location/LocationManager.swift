...
public final class LocationManager: NSObject {
    ...
    public private(set) var latitude = 37.3230
    public private(set) var longitude = -122.0323
...
extension LocationManager: @MainActor CLLocationManagerDelegate {
    public func locationManager(_ manager: CLLocationManager, didUpdateLocations locations: [CLLocation]) {
            ...
            Task { @MainActor in self.update(location.coordinate.latitude, location.coordinate.longitude) }
        }
